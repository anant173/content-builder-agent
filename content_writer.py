...
tfy_base_url = os.environ.get("TFY_BASE_URL")
...
def write_file(content: str, platform: str, slug: str) -> str:
    ...
    Args:
        ...
        platform: Either "blogs", "linkedin" or "tweets"
        slug: Blog post slug. Content saves to <platform>/<slug>/post.md 


    """
    output_path = EXAMPLE_DIR / platform / slug / "post.md"
...
def create_content_writer():
    ...
    return create_deep_agent(
        ...
        tools=[write_file, generate_cover, generate_social_image],  # Writing and Image generation
